...
const AdminList = () => {
  ...
  const openModal = (op, admin) => {
    ...
    if (op === 1) {
      ...
      registrationDate.handleChange("");
      lastVisitDate.handleChange("");
    } else if (op === 2) {
      ...
      language.handleChange(admin?.language);
      registrationDate.handleChange(admin?.registrationDate);
      lastVisitDate.handleChange(admin?.lastVisitDate);
  ...
  const validar = (id) => {
    ...
    if (
      ...
      type.input === "" ||
      language.input.trim() === "" ||
      registrationDate.input.trim() === "" ||
      lastVisitDate.input.trim() === ""
    ) {
      ...
      if (operation === 1) {
        parametros = {
          ...
          registrationDate: registrationDate.input,
          lastVisitDate: lastVisitDate.input,
        };
        metodo = "post";
      } else if (operation === 2) {
        parametros = {
