...
export const deleteQuestion = async (questiondetails, config, updateSurveyQuestions,t) => {
...
export const sendData = async (metodo, parametros,config,idToEdit,setLoading,setError,updateSurveyQuestions,t) => {
    try {
