...
const SidebarLT2 = () => {
  ...
  return (
    ...
    <div className="col-1 col-md-1 col-lg-1 d-lg-block d-none h-100 rounded-end-4 collapse  navbar-collapse ps-2 align-content-center "style={{position:"absolute"}}
      id="navbarNav"
    >
      <div id="div_ul" className="d-flex align-content-center justify-content-center">
        <ul className="pt-3 rounded-end-4">
          <li className="nav-item">
            <a className="nav-link tooltip-container" href={userType===3? "/editor": "/index=Quality"}>
      ...
      <div className="modal fade" tabIndex="-1"  aria-hidden="false" id="userModalInfo2">
